...
{
    public partial class T_bookingReportForm : Form
    {
        public T_bookingReportForm()
        {
            InitializeComponent();
        }

        private void T_bookingReportForm_Load(object sender, EventArgs e)
        {
        ...
        private void reportViewer1_Load(object sender, EventArgs e)
        {
            ...
            // Set the report path
            reportViewer1.LocalReport.ReportPath = "T_bookingReport.rdlc";
